...
describe("invalidateReactQueryCommand", () => {
  it("should invalidate query when queryKey is provided", () => {
    ...
    // Assertion
    expect(queryClientManagerMock.invalidateQueries).toHaveBeenCalledWith("exampleQueryKey")
  })
  ...
  it("should not invalidate query when queryKey is not provided", () => {
    ...
    // Assertion
    expect(queryClientManagerMock.invalidateQueries).toHaveBeenCalledWith(undefined)
  })
})
